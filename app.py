...
def crop_image(image):
    '''
        function that will take in the stitched image and return it after cropping it. 
        First, convert the stitched image to grayscale. 
        Then apply a binary threshold to create a binary image. 
        Finally, find the largest contour in the binary image and calculate its bounding rectangle.
    '''
...
# function call
stitch_folder(folder_path="path")